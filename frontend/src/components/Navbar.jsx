    ...
    <>
      ...
      <header style={{
        ...
        <div style={{
            ...
            {NAV_LINKS.map(({ label, href }) => (
              <a key={label} href={href}
                ...
                style={{
                  ...
                  color: hovered === label ? C.ink : C.inkMid, textDecoration: "none",
          ...
          {/* Desktop GitHub — hidden below md */}
          <a href="https://github.com/ArnavUpadhyay7/Zentra/"
            ...
            style={{
              ...
              color: ghHover ? C.ink : C.inkMid, textDecoration: "none",
          ...
          <button
            ...
            style={{
              width: 40, height: 40, borderRadius: 10, gap: 5,
              background: open ? "#F3EFE8" : "transparent",
              border: `1.5px solid ${open ? C.border : "transparent"}`,
              transition: "all 0.2s ease",
            }}
          >
            <span style={{ display: "block", width: 18, height: 1.5, borderRadius: 2, background: C.ink, transition: "transform 0.25s ease", transform: open ? "translateY(6.5px) rotate(45deg)" : "none" }} />
            <span style={{ display: "block", width: 18, height: 1.5, borderRadius: 2, background: C.ink, transition: "opacity 0.2s ease", opacity: open ? 0 : 1 }} />
            <span style={{ display: "block", width: 18, height: 1.5, borderRadius: 2, background: C.ink, transition: "transform 0.25s ease", transform: open ? "translateY(-6.5px) rotate(-45deg)" : "none" }} />
          </button>
        </div>
              ...
              {NAV_LINKS.map(({ label, href }) => (
                <a key={label} href={href}
                  ...
                  style={{
                    ...
                    padding: "4px 0px", borderRadius: 12,
