...
const COMING_SOON = [
  { name: "Neon City", description: "Rain-slicked streets and rooftop gardens." },
  { name: "Forest Shrine", description: "Ancient trees and quiet clearings." },
  { name: "Space Station", description: "Zero-g corridors and observation decks." },
];

export default function MapDrawer({ open, onSelect, onClose }) {
  const [selected, setSelected] = useState("tiny-dungeon");
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: "22px", fontWeight: 800, color: "#030712", fontFamily: "'Bricolage Grotesque', sans-serif", letterSpacing: "-0.03em" }}>
              Pick your space
            </div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "24px 24px 0" }}>
          ...
          {/* Available maps */}
          <div style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "0.1em", color: "#9ca3af", textTransform: "uppercase", marginBottom: "12px", fontFamily: "'DM Sans', sans-serif" }}>
            Available
          </div>
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: isSelected ? "#6366f1" : "rgba(0,0,0,0.55)",
                    color: "#fff",
                ...
                <div style={{ padding: "16px 18px" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "6px" }}>
                    <div style={{ fontSize: "16px", fontWeight: 800, color: "#030712", fontFamily: "'Bricolage Grotesque', sans-serif", letterSpacing: "-0.02em" }}>
                      {map.name}
                    </div>
                    <div style={{ fontSize: "11px", color: "#9ca3af", display: "flex", alignItems: "center", gap: "4px", fontFamily: "'DM Sans', sans-serif" }}>
                      <span style={{ color: "#22c55e", fontSize: "8px" }}>●</span> {map.players}
                    </div>
                  </div>
                  <div style={{ fontSize: "13px", color: "#6b7280", lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif" }}>
                    {map.description}
                  </div>
                </div>
              </div>
          ...
          {COMING_SOON.map((map, i) => (
            <div key={i} style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: "14px", fontWeight: 600, color: "#9ca3af", marginBottom: "3px", fontFamily: "'Bricolage Grotesque', sans-serif" }}>
                  {map.name}
                </div>
                <div style={{ fontSize: "12px", color: "#d1d5db", lineHeight: 1.4, fontFamily: "'DM Sans', sans-serif" }}>
                  {map.description}
                </div>
              </div>
              <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", fontSize: "12px", color: "#d1d5db", marginTop: "10px", fontFamily: "'DM Sans', sans-serif" }}>
